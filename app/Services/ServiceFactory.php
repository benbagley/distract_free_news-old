...
class ServiceFactory
{
  ...
  public function get($service, $limit = 12)
  {
  ...
  public function hackernews($limit = 12)
  {
  ...
  protected function reddit($limit = 12)
  {
  ...
  protected function producthunt($limit = 12)
  {
  ...
  protected function bbcnews($limit = 12)
  {
  ...
  protected function thetelegraph($limit = 12)
  {
  ...
  protected function theindependent($limit = 12)
  {
